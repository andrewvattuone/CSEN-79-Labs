...
namespace lab5_avattuone
{
    ...
    public:
        ...
        void operator +=(char addend);
        void reserve(size_t n);
        // if you have info in your string, then allocate 6 allocated space for string hello (5 characters plus null terminator)
        ...
        // use compare functions for this stuff
